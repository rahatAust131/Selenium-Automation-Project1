...
def handle_custom_field_save_button():
    ...
    try:
        ...
        save_btn.click()
        time.sleep(3)
        write_in_file("Log/report.txt", "Custom field Save button clicked successfully!")
    except Exception as e:
        write_in_file("Log/report.txt", "Custom field Save button click exception: " + type(e).__name__)
