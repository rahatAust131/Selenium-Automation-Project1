...
def handle_marital_status():
    ...
    try:
        ...
        write_in_file("Log/report.txt", "Marital Status: " + marital_status_field.text + " entered successfully!")
    except Exception as e:
        write_in_file("Log/report.txt", "Marital Status field exception: " + type(e).__name__)
