...
def handle_driving_license():
    ...
    try:
        ...
        driver_license_field.send_keys("5454545454")
        write_in_file("Log/report.txt", "Driver license number: " + driver_license_field.get_attribute(
            'value') + " entered successfully!")
    except Exception as e:
        write_in_file("Log/report.txt", "Driver license number field exception: " + type(e).__name__)
    ...
    try:
        ...
        license_expiry_date_field.send_keys("2025-12-01")
        write_in_file("Log/report.txt", "license Expiry date field: " + license_expiry_date_field.get_attribute(
            'value') + " entered successfully!")
    except Exception as e:
        write_in_file("Log/report.txt", "license Expiry date field exception: " + type(e).__name__)
