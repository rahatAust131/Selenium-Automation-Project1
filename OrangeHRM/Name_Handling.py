...
def handle_names():
    ...
    try:
        ...
        write_in_file("report.txt", "First Name: " + firstname_field.get_attribute('value') + " entered successfully!")
    except Exception as e:
        write_in_file("report.txt", "Firstname field exception: " + type(e).__name__)
    ...
    try:
        ...
        write_in_file("report.txt", "Middle name field exception: " + type(e).__name__)
    ...
    try:
        ...
        write_in_file("report.txt", "Last Name: " + lastname_field.get_attribute('value') + " entered successfully!")
    except Exception as e:
        write_in_file("report.txt", "Last name field exception: " + type(e).__name__)
    ...
    try:
        ...
        write_in_file("report.txt", "Nickname: " + nickname_field.get_attribute('value') + " entered successfully!")
    except Exception as e:
        write_in_file("report.txt", "Nickname field exception: " + type(e).__name__)