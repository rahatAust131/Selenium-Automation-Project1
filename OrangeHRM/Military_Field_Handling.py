...
def handle_military_service_field():
    try:
        ...
        military_service_field.send_keys(0)
        write_in_file("report.txt", "Military Service field value: " + military_service_field.get_attribute('value') + " entered successfully!")
    except Exception as e:
        write_in_file("report.txt", "Military Service Field Exception: " + type(e).__name__)
