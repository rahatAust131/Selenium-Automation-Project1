...
def handle_my_info():
    ...
    try:
        ...
        my_info_btn.click()
        write_in_file("Log/report.txt", "My Info button clicked successfully!")
        ...
        write_in_file("Log/report.txt", "My Info Page opened successfully!")
    except Exception as e:
        write_in_file("Log/report.txt", "My Info button click exception: " + type(e).__name__)
