...
def handle_login_info(username, password):
    ...
    try:
        ...
        write_in_file("report.txt", "username typed successfully!")
    except Exception as e:
        write_in_file("report.txt", "username field exception: " + type(e).__name__)
    ...
    try:
        ...
        write_in_file("report.txt", "password typed successfully!")
    except Exception as e:
        write_in_file("report.txt", "password field exception: " + type(e).__name__)
    ...
    try:
        ...
        login_btn.click()
        write_in_file("report.txt", "Login button clicked successfully!")
        ...
        write_in_file("report.txt", "Dashboard page opened successfully!")

    except Exception as e:
        write_in_file("report.txt", "button click exception: " + type(e).__name__)
